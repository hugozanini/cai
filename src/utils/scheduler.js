            ...
            if (!hasLunch && preferences.lunchDuration > 0) {
                ...
                if (lunchSlotDetails) {
                    ...
                    await createEvent(token, {
                        summary: '🍽️ Lunch',
                        description: '<i>Generated by <b>Cai</b> – your enterprise calendar intelligence.</i><br/><br/>Enjoy your meal and take a well-deserved break!',
            ...
            if (!hasCoffee && coffeeMins > 0) {
                ...
                if (coffeeSlotDetails) {
                    ...
                    await createEvent(token, {
                        ...
                        description: '<i>Generated by <b>Cai</b> – your enterprise calendar intelligence.</i><br/><br/>Take a moment to step away and recharge.',
            ...
            if (neededSecs > 0) {
                ...
                for (const slot of freeSlots) {
                    ...
                    while (slotDurationSecs >= 1800 && neededSecs > 0) { // at least 30 mins
                        ...
                        await createEvent(token, {
                            summary: '⚡ Focus Time',
                            description: '<i>Generated by <b>Cai</b> – your enterprise calendar intelligence.</i><br/><br/>This block is protected for deep work. Silence your notifications and focus on what matters most.',
